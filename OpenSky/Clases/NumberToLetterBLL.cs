...
{
    public class NumberToLetterBLL
    {
        ...
        public string convert_number_to_letter(string numero, bool mayusculas, string moneda)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                if (mayusculas)
                {
                    if (moneda == "USD")
                    {
                        return (literal).ToUpper() + parte_decimal;
                    }
                    else
                    {
        ...
        { //000 000 000
          //se obtiene los miles
            ...
            int primerNumero = Convert.ToInt32(millon);
            string n = "";
            if (millon.Length > 1)
            {
